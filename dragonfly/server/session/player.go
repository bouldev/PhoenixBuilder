...
import (
	...
	"phoenixbuilder/dragonfly/server/item/creative"
	"phoenixbuilder/dragonfly/server/item/inventory"
	"phoenixbuilder/dragonfly/server/item/recipe"
...
//go:linkname item_id phoenixbuilder/dragonfly/server/item.id
//noinspection ALL
func item_id(s item.Stack) int32

//go:linkname world_add phoenixbuilder/dragonfly/server/world.add
//noinspection ALL
