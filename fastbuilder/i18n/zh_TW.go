...
var I18nDict_zh_TW map[uint16]string = map[uint16]string{
	...
	Original_Important_Contributor:      "原始的重要貢獻者: LNSSPsd(Ruphane), CAIMEO, CMA2401PT",
	...
	Warning_ACME_Deprecated:             "警告 - `acme' 功能已棄用且已移除，請轉移到BDX格式。",
	Warning_Schem_Deprecated:            "警告 - `schem' 功能已棄用且已移除，請轉移到BDX格式。",
	Warning_UserHomeDir:                 "警告 - 無法獲取當前user主目錄，將設定homedir=\".\";\n",
	Auth_MessageFromAuthServer:          "來自驗證伺服器的讯息: %s",
}
