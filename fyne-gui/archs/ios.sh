...
then
  ...
  exec $THEOS/toolchain/linux/iphone/bin/clang -F$THEOS/vendor/lib -target arm64-apple-ios11.0 -isysroot $THEOS/sdks/iPhoneOS12.2.sdk -F$THEOS/sdks/iPhoneOS12.2.sdk/System/Library/PrivateFrameworks -framework Foundation -framework CoreFoundation -framework UIKit -framework CoreGraphics -framework CoreUI -Wno-unused-command-line-argument -lSystem $@
fi
