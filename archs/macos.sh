...
then
  ...
  exec $THEOS/toolchain/linux/iphone/bin/clang -F$THEOS/vendor/lib -target x86_64-apple-darwin -target arm64-apple-darwin -isysroot $THEOS/sdks/MacOSX11.0.sdk $@
fi
