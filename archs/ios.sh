...
then
  ...
  exec $THEOS/toolchain/linux/iphone/bin/clang -F$THEOS/vendor/lib -target arm64-apple-ios9.0 -target arm64-apple-darwin -isysroot $THEOS/sdks/iPhoneOS9.3.sdk $@
fi
