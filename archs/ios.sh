...
then
  ...
  exec $THEOS/toolchain/linux/iphone/bin/clang -F$THEOS/vendor/lib -target arm64-apple-ios14.0 -target arm64-apple-darwin -isysroot $THEOS/sdks/iPhoneOS14.5.sdk $@
fi
