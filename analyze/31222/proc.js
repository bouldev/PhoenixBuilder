...
function resolve(hexval) {
	...
	let listfile=fs.readFileSync("nemc-onlycode.txt").toString();
...
fs.writeFileSync(process.argv[2]+"_output.pyc",Buffer.concat([Buffer.from("03f30d0a00000000","hex"),file]));