...
build/phoenixbuilder-android-executable-x86: build/ CGO_LDFLAGS="-Wl,-rpath,/data/data/com.termux/files/usr/lib" ${HOME}/android-ndk-r20b/toolchains/llvm/prebuilt/linux-x86_64/bin/i686-linux-android21-clang ${SRCS_GO}
...
build/phoenixbuilder-freebsd-executable-x86:
	cd depends/stub&&make clean&&make ALT_CLANG="${HOME}/llvm/bin/clang" CC="`pwd`/../buildroot/freebsd/bin/clang -target i686-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/i386 -L`pwd`/../buildroot/freebsd/i386/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-x86_64:
	cd depends/stub&&make clean&&make ALT_CLANG="${HOME}/llvm/bin/clang" CC="`pwd`/../buildroot/freebsd/bin/clang -target amd64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/amd64 -L`pwd`/../buildroot/freebsd/amd64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-arm64:
	cd depends/stub&&make clean&&make ALT_CLANG="${HOME}/llvm/bin/clang" CC="`pwd`/../buildroot/freebsd/bin/clang -target aarch64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/arm64 -L`pwd`/../buildroot/freebsd/arm64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86:
	cd depends/stub&&make clean&&make ALT_LD="${HOME}/llvm/bin/ld.lld" CC="${HOME}/llvm/bin/clang -target i386-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/i386 -L`pwd`/../buildroot/openbsd/i386/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86_64:
	cd depends/stub&&make clean&&make ALT_LD="${HOME}/llvm/bin/ld.lld" CC="${HOME}/llvm/bin/clang -target amd64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/amd64 -L`pwd`/../buildroot/openbsd/amd64/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-arm64:
	cd depends/stub&&make clean&&make ALT_LD="${HOME}/llvm/bin/ld.lld" CC="${HOME}/llvm/bin/clang -target arm64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/arm64 -L`pwd`/../buildroot/openbsd/arm64/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
