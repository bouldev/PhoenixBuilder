...
build/phoenixbuilder-openbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target i386-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/i386 -L`pwd`/../buildroot/openbsd/i386/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target amd64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/amd64 -L`pwd`/../buildroot/openbsd/amd64/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target arm64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/arm64 -L`pwd`/../buildroot/openbsd/arm64/usr/lib -fuse-ld=`pwd`/../buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
