...
build/phoenixbuilder-netbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target aarch64--netbsd --sysroot=`pwd`/../buildroot/netbsd/arm64 -L`pwd`/../buildroot/netbsd/arm64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target i386-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/i386 -L`pwd`/../buildroot/openbsd/i386/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target amd64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/amd64 -L`pwd`/../buildroot/openbsd/amd64/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target arm64-unknown-openbsd --sysroot=`pwd`/../buildroot/openbsd/arm64 -L`pwd`/../buildroot/openbsd/arm64/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
