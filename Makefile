...
build/phoenixbuilder-freebsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target i686-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/i386 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target amd64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/amd64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target aarch64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/arm64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target i386--netbsd --sysroot=`pwd`/../buildroot/netbsd/i386 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target amd64--netbsd --sysroot=`pwd`/../buildroot/netbsd/amd64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target aarch64--netbsd --sysroot=`pwd`/depends/buildroot/netbsd/arm64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
