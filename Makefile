...
build/phoenixbuilder-ish-executable: build/ ${SRCS_GO}
	cd depends/stub&&make clean&&make CC="${HOME}/i686-unknown-linux-musl/bin/i686-unknown-linux-musl-gcc --sysroot=`pwd`/depends/buildroot/ish"&&cd -
...
build/phoenixbuilder-freebsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target i686-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/i386 -L`pwd`/../buildroot/freebsd/i386/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target amd64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/amd64 -L`pwd`/../buildroot/freebsd/amd64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/freebsd/bin/clang -target aarch64-unknown-freebsd --sysroot=`pwd`/../buildroot/freebsd/arm64 -L`pwd`/../buildroot/freebsd/arm64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target i386--netbsd --sysroot=`pwd`/../buildroot/netbsd/i386 -L`pwd`/../buildroot/netbsd/i386/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target amd64--netbsd --sysroot=`pwd`/../buildroot/netbsd/amd64 -L`pwd`/../buildroot/netbsd/amd64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/../buildroot/netbsd/bin/clang -target aarch64--netbsd --sysroot=`pwd`/depends/buildroot/netbsd/arm64 -L`pwd`/../buildroot/netbsd/arm64/usr/lib -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target i386-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/i386 -L`pwd`/../buildroot/openbsd/i386/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target amd64-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/amd64 -L`pwd`/../buildroot/openbsd/amd64/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target arm64-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/arm64 -L`pwd`/../buildroot/openbsd/arm64/usr/lib -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
