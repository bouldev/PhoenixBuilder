...
build/phoenixbuilder-freebsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/freebsd/bin/clang -target i686-unknown-freebsd --sysroot=`pwd`/depends/buildroot/freebsd/i386 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/freebsd/bin/clang -target amd64-unknown-freebsd --sysroot=`pwd`/depends/buildroot/freebsd/amd64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-freebsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/freebsd/bin/clang -target aarch64-unknown-freebsd --sysroot=`pwd`/depends/buildroot/freebsd/arm64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/netbsd/bin/clang -target i386--netbsd --sysroot=`pwd`/depends/buildroot/netbsd/i386 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/netbsd/bin/clang -target amd64--netbsd --sysroot=`pwd`/depends/buildroot/netbsd/amd64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-netbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="`pwd`/depends/buildroot/netbsd/bin/clang -target aarch64--netbsd --sysroot=`pwd`/depends/buildroot/netbsd/arm64 -fuse-ld=${HOME}/llvm/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target i386-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/i386 -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-x86_64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target amd64-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/amd64 -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
...
build/phoenixbuilder-openbsd-executable-arm64:
	cd depends/stub&&make clean&&make CC="${HOME}/llvm/bin/clang -target arm64-unknown-openbsd --sysroot=`pwd`/depends/buildroot/openbsd/arm64 -fuse-ld=`pwd`/depends/buildroot/openbsd/bin/ld.lld -Wno-unused-command-line-argument"&&cd -
