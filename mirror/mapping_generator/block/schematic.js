...
var fs = require("fs")
var data = fs.readFileSync('/Users/dai/projects/PhoenixBuilder/convert_out/javaBlockToRid.json');
javaToRTID=JSON.parse(data)
hit=0
miss=0
for (blockName in javaToRTID){
    schematicID=convertToLegacyBlockId(blockName)
    if (schematicID===0){
        miss++
    }else{
        hit++
